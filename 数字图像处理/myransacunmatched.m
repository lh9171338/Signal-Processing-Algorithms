function [model,matches] = myransacunmatched(callbacks,model,data1,data2,modelPoints,minNumInlier,threshold,maxIters)
%MYRANSACUNMATCHED - RANdom SAmple Consensus algorithm of unmatched data
%
%   model = myransacunmatched(callbacks,model,data1,data2,modelPoints,minNumInlier,threshold)
%   model = myransacunmatched(callbacks,model,data1,data2,modelPoints,minNumInlier,threshold,maxIters)
